...
namespace WootMouseRemap.UI
{
    partial class AdvancedMouseSettingsCompactForm
    {
        ...
        private Button btnAntiRecoilSettings;
        ...
        private void InitializeComponent()
        {
            ...
            btnAntiRecoilSettings = new Button { Text = "Anti-Recoil", Dock = DockStyle.Right, Width = 100 };
            panelTop.Controls.Add(chkEnableMouseRemap);
            panelTop.Controls.Add(btnSave);
            panelTop.Controls.Add(btnClose);
            panelTop.Controls.Add(btnAntiRecoilSettings);
