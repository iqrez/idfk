...
namespace WootMouseRemap.UI
{
    ...
    public static class AdvancedFeatures
    {
        ...
        public static class DataExporter
        {
            ...
            {
                return System.Text.Json.JsonSerializer.Deserialize<AntiRecoilPattern>(json, new System.Text.Json.JsonSerializerOptions
                {
                    PropertyNamingPolicy = System.Text.Json.JsonNamingPolicy.CamelCase
                }) ?? throw new InvalidOperationException("Failed to deserialize pattern");
            }
        }
    }
