...
namespace WootMouseRemap.Tests
{
    ...
    public class ViewModelTests
    {
        ...
        public void ViewModel_LoadFromNullAntiRecoil_ShouldNotThrow()
        {
            ...
            }, "LoadFrom should throw ArgumentNullException for null parameter");
        }
        ...
        public void ViewModel_ApplyToNullAntiRecoil_ShouldNotThrow()
        {
            ...
            }, "ApplyTo should throw ArgumentNullException for null parameter");
        }
        ...
        {
            var changeCount = 0;
            _viewModel.PropertyChanged += (sender, e) => changeCount++;
            ...
            Assert.AreEqual(0, changeCount, "PropertyChanged should not fire when setting to same value");

            // Set to different value
            _viewModel.Strength = originalStrength + 0.1f;

            Assert.AreEqual(1, changeCount, "PropertyChanged should fire when setting to different value");
        }
    }
}